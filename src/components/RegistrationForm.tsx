    ...
    <div className="w-full max-w-2xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
      ...
      <form noValidate onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div><label htmlFor="policeStation" className="block text-sm font-medium text-gray-300">Locality Police Station</label><input id="policeStation" {...register("policeStation")} className="mt-1 block w-full input-style" /></div>
          <div><label htmlFor="postOffice" className="block text-sm font-medium text-gray-300">Locality Post Office</label><input id="postOffice" {...register("postOffice")} className="mt-1 block w-full input-style" /></div>
