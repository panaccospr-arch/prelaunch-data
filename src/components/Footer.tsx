      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-end order-3">
            ...
            <div className="space-y-3 text-right">
              ...
              <a href="mailto:services@panacco.com" className="flex items-center justify-center md:justify-end space-x-2 text-gray-400 hover:text-white transition-colors"><svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"/></svg><span>services@panacco.com</span></a>
            </div>
        </div>
      </div>
    </footer>
